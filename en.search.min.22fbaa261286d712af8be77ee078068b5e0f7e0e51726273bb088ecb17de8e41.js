...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3963eee7a4ce61a003ffd67a5509a0178df4430914ce8b57e6ced9877800f6a0.js',function(){input.required=false;search();});}

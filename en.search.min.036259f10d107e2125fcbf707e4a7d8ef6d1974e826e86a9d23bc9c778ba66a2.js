...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f6adb72763aab3d7d2e5997d5ba7fc7ed184efd7747f94012a4f2848d2c142e7.js',function(){input.required=false;search();});}

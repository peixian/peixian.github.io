...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.85770ff45db72a7df6b18b849218f97b2185f13aba60399255e45a28b9dffd1b.js',function(){input.required=false;search();});}

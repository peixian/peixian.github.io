...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d49af63001c6336e3bc89b13955e9aa2509128e314a4a3efcc8d8cc336d179fa.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.93d2339cafdf30f3050eccc18cf81a1542309644f9a0834ba46a6e57be3f8650.js',function(){input.required=false;search();});}

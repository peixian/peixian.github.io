...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.011b488576f6dc3b4bcdf9037fc23af7a4b6123900121b475fa1bd5d5a2b0ea4.js',function(){input.required=false;search();});}

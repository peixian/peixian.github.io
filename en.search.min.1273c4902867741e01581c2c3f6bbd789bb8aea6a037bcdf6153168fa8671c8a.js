...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a58d8b51647edbc641be63d1cfa326f57f2e08a213b89f08aec3e0a3dc9c1a33.js',function(){input.required=false;search();});}

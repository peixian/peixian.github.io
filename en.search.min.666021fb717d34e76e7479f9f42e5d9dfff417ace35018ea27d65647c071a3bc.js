...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.144bb377b330d4b6a93d0621b7747ba4f75a2d7fcee7371b1108a2aa4bfd9dd4.js',function(){input.required=false;search();});}

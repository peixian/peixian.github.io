...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5c8663d037739832d1c15defaa6f6e0bc9c0622d2be8add3265094e90d1f20b3.js',function(){input.required=false;search();});}

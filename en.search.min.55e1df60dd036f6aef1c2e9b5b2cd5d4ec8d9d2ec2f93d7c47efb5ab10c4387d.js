...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.258d5b67c6fb15e69eae9073d16fc18cd9d885eacd641490224f31d75208717e.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6fe34377bd06da3a0b3b13695e2628698563ecf17e65e2758787a9fc6bdbc7a5.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a35ecf124ea1ed4d1439eddd7596a598e18892356ff89a605f58a70831a0fff3.js',function(){input.required=false;search();});}

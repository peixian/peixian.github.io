...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.de56cc928b170137fe39e8b841e2cbdccfb5867115fbae07c1a7db84cbf383c1.js',function(){input.required=false;search();});}

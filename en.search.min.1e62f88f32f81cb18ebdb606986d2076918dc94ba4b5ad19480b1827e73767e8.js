...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.641b333ca4a2b35bc01c00bedecc4375ff8b9223cdbccc96d4a5d46bbf3d8a18.js',function(){input.required=false;search();});}

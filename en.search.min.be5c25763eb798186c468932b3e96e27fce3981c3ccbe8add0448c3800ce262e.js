...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0b5f38a26414b48ca988b4149453469db0845ba791152fbd069552d6ef405aaf.js',function(){input.required=false;search();});}

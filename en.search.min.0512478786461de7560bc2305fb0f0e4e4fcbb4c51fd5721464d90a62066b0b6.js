...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5243bfcf55ba61e2e217eca59f0154ca17dd83dc3b60cebfacb8c04854c6db25.js',function(){input.required=false;search();});}

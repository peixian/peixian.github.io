...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.17d6e4ebb863fadd9d24131cf36473a50520a1f55b1f3ae3abdf8baa5f4ef269.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.146384e63dd396a3d2cbea0061da0a590d38963e1dcc2987dedf370db240b9b8.js',function(){input.required=false;search();});}

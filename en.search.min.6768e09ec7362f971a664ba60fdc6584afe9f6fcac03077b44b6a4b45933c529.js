...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3e92020f02b7978c2eaa36a3d420216249e1bd18dd60485d9fc8c29bdfcb67f8.js',function(){input.required=false;search();});}

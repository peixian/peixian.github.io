...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e1682c3433546db4681b3ee98e18dfe70f52fa1c1464654c60837f91a7f909ca.js',function(){input.required=false;search();});}

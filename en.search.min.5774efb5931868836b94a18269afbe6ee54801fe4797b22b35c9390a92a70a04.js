...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6085be88c8b46ddb6db7a5452dd1a40b5715c8b3068ec22fdac59dd17fd6500f.js',function(){input.required=false;search();});}

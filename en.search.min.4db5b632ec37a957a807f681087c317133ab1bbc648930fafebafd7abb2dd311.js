...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f64acdf2b919af9c359dc7ffbd1b8cebdbbf9d04cc6d665a211902b1d76a3ebb.js',function(){input.required=false;search();});}

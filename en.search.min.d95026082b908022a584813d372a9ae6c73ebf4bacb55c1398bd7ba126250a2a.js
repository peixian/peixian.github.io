...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.91d3d0babd57fe40ceca2f5d0b78532ccff395e9ccdde2c2c4544f117518f91d.js',function(){input.required=false;search();});}

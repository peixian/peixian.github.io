...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7cd83b314006e9cd67523f85c43fb3a0e692f99ebbdaa206297a0232e957f257.js',function(){input.required=false;search();});}

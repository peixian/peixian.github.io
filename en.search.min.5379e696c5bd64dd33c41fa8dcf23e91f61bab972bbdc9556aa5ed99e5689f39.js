...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5a98878a070bca41732ce5df46ebdfeafc5504d6a7831c6dcfb04d7336cd2fca.js',function(){input.required=false;search();});}

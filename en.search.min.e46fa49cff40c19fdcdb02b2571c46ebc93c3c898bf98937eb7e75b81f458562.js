...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c6a8787f223e30bc20cc8d688fa7dff6a06aa6adee4a025657aacd1e32a7b8ed.js',function(){input.required=false;search();});}

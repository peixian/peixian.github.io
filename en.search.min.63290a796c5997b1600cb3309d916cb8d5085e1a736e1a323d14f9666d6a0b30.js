...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f715301c333d9419d5fbb167eb30a3fe186e515b44f7faf2de4a6d567410a57f.js',function(){input.required=false;search();});}

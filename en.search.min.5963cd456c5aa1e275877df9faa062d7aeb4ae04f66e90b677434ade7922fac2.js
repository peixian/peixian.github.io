...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6d6273409026f2d9b0b74b2f7234cc90a98cf9a5e370284efcd2d8fc9fc5a8ec.js',function(){input.required=false;search();});}
